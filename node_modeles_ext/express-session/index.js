...
function getcookie(req, name, secrets) {
    ...
    if (header) {
         ...
         * return raw;
         * ++
         * in order to skip the parsing of the sid
         */
        return raw; //ec_m_add:160619
        /*
        //block_1466394619377_s
        ...
        //block_1466394619377_e
        */
    }
    /*
    //block_1466394619378_s
...
function setcookie(res, name, val, secret, options) {
     ...
     * var signed = val;
     * ++
     * in order to skip the wrapping of the sid
     */
    //var signed = 's:' + signature.sign(val, secret);//ec_m_add:160619
    var signed = val;//ec_m_add:160619
