...
(function (window) {
    ...
    var Recorder = function (stream, config) {
        ...
        config.sampleRate = config.sampleRate || (44100 / 4);   //采样率(11k HZ)
                    ...
                    , function (error) {
                        switch (error.code || error.name) {
                            ...
                            case 'NotSupportedError':
                                Recorder.throwError('<a href="http://www.it165.net/edu/ewl/" target="_blank" class="keylink">浏览器</a>不支持硬件设备。');
                                break;
