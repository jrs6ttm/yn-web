...
function getCourseCard(obj) {
    ...
    if (obj.STATUS === '3') {
        ...
        return '<div class="_home_courseCon _course" data-status="' + obj.STATUS + '" data-orgId="' + obj.LRNSCN_ORG_ID +'" data-courseId="' + obj.INSTANCE_ID +
            ...
            data.config.coursePlayer + 'course#' + obj.INSTANCE_ID + '" target="_blank"><label class="status-description"></label><img class="_home_courseImg img-thumbnail"' + 'alt="' + obj.INSTANCE_NAME + '" title="' + obj.INSTANCE_NAME +
