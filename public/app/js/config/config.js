...
var config = {
  ...
  coursemonitor: {
    dev: 'http://comsocket.xuezuowang.com',
    joint: 'http://comsocket.learn.com',
    prod: 'http://comsocket.xuezuowang.com'
  },
  courselog: {
    dev: window.location.origin,
    joint: window.location.origin,
  ...
  ecedit: {
    dev: 'http://authoring2.xuezuowang.com',
    joint: 'http://authoring.learn.com',
    prod: 'http://authoring2.xuezuowang.com'
  },
  courseorg: {
    dev: window.location.origin,
    joint: window.location.origin,
