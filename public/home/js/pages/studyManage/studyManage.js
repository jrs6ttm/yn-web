...
;(function($){
    ...
    StudyManage.prototype = {
        ...
        showCourseList : function(){
            ...
            var watchTasks = createEle('iframe');
            watchTasks.src = ecgeditorPort + '/searchLogs';
            $(watchTasks).css({width: '100%', height: 1015, scrolling: 'no', border: 0});
            $('._page_view').append(watchTasks);
        ...
        init : function(val){
            ...
            if(val === 'studyManage'){
                ...
                var courseName      = createEle('div');courseName.className = "page-header";courseName.innerHTML = '学习管理';courseNameCon.appendChild(courseName);
